...
<style scoped>
.achievements-page { padding-block: clamp(64px, 9vh, 104px) 72px; }.page-intro { max-width: 690px; margin-bottom: 32px; }.achievement-directory { padding: clamp(22px, 4vw, 36px); }
