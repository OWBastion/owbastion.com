  ...
  <main class="me-page page-shell">
    <template v-if="player">
      ...
      <section class="section-block titles-section" aria-labelledby="titles-title">
        <PageSectionHeader title="最近获得的称号" heading-id="titles-title"><template #actions><UButton to="/achievements" label="查看全部成就" color="neutral" variant="outline" /></template></PageSectionHeader>
      ...
      <section class="upcoming-section" aria-labelledby="upcoming-title">
        <PageSectionHeader eyebrow="未开放" title="更多功能" heading-id="upcoming-title" />
    ...
    <div v-else-if="loading" class="me-skeleton" role="status" aria-label="读取中…">
      <section class="me-skeleton-intro" aria-hidden="true"><div class="me-skeleton-intro-copy"><USkeleton class="me-skeleton-eyebrow" /><USkeleton class="me-skeleton-heading" /></div><USkeleton class="me-skeleton-intro-action" /></section>
      ...
      <section class="me-skeleton-section" aria-hidden="true">
        <div class="me-skeleton-section-heading me-skeleton-section-heading-plain"><USkeleton class="me-skeleton-section-title" /></div>
...
.me-skeleton { display: grid; }.me-skeleton-intro { display: flex; align-items: flex-end; justify-content: space-between; gap: 32px; margin-bottom: 32px; }.me-skeleton-intro-copy { display: grid; gap: 14px; min-width: 0; max-width: 690px; }.me-skeleton-intro-action { flex: 0 0 auto; width: 132px; height: 44px; border-radius: 999px; }.me-skeleton-eyebrow { width: 72px; height: 12px; }.me-skeleton-heading { width: min(58%, 360px); height: 46px; }.me-skeleton-identity { display: flex; align-items: center; gap: 15px; padding: 22px; }.me-skeleton-avatar { flex: 0 0 auto; width: 48px; height: 48px; border-radius: 50%; }.me-skeleton-identity-copy { display: grid; flex: 1; gap: 8px; min-width: 0; }.me-skeleton-identity-label { width: 54px; height: 12px; }.me-skeleton-identity-name { width: min(44%, 220px); height: 25px; }.me-skeleton-identity-status { display: grid; flex: 0 0 auto; gap: 8px; justify-items: end; }.me-skeleton-identity-status-label { width: 48px; height: 12px; }.me-skeleton-identity-status-value { width: 58px; height: 22px; border-radius: 999px; }.me-skeleton-section { display: grid; gap: 16px; margin-top: clamp(56px, 8vw, 88px); }.me-skeleton-section.titles-section { margin-top: clamp(52px, 8vw, 86px); }.me-skeleton-section-heading { display: flex; align-items: center; justify-content: space-between; gap: 16px; }.me-skeleton-section-heading-plain { align-items: flex-start; flex-direction: column; gap: 10px; }.me-skeleton-section-eyebrow { width: 48px; height: 11px; }.me-skeleton-section-title { width: 150px; height: 22px; }.me-skeleton-action { width: 118px; height: 40px; border-radius: 999px; }.me-skeleton-title-grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 12px; }.me-skeleton-title-card { display: grid; min-height: 132px; align-content: start; gap: 10px; padding: 18px; border: 1px solid var(--line); border-radius: 16px; background: color-mix(in oklch, var(--surface-raised) 76%, var(--surface)); }.me-skeleton-title-kicker { width: 64px; height: 11px; }.me-skeleton-title-name { width: 72%; height: 21px; }.me-skeleton-title-copy { width: 92%; height: 13px; }.me-skeleton-submission-list { display: grid; gap: 10px; }.me-skeleton-submission-row { display: flex; align-items: center; justify-content: space-between; gap: 22px; min-height: 78px; padding: 18px 20px; border: 1px solid var(--line); border-radius: 18px; background: var(--surface); }.me-skeleton-submission-copy { display: grid; flex: 1; gap: 8px; min-width: 0; }.me-skeleton-submission-name { width: min(42%, 220px); height: 18px; }.me-skeleton-submission-date { width: 30%; height: 12px; }.me-skeleton-submission-status { width: 68px; height: 24px; border-radius: 999px; }.me-skeleton-upcoming-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 12px; }.me-skeleton-upcoming-card { display: flex; min-height: 17rem; flex-direction: column; justify-content: space-between; padding: 22px; }.me-skeleton-upcoming-top { display: flex; align-items: center; justify-content: space-between; gap: 12px; }.me-skeleton-upcoming-index { width: 20px; height: 12px; }.me-skeleton-upcoming-badge { width: 54px; height: 23px; border-radius: 999px; }.me-skeleton-upcoming-copy { display: grid; gap: 10px; }.me-skeleton-upcoming-kicker { width: 72px; height: 12px; }.me-skeleton-upcoming-title { width: 124px; height: 24px; }
...
@media (max-width: 620px) { .intro { align-items: stretch; flex-direction: column; gap: 22px; }.intro-action { width: 100%; justify-content: center; }.me-skeleton-intro { align-items: stretch; flex-direction: column; gap: 22px; margin-bottom: 20px; }.me-skeleton-intro-action { width: 100%; }.me-skeleton-heading { width: 76%; height: 38px; }.me-skeleton-identity { align-items: flex-start; flex-wrap: wrap; padding: 18px; }.me-skeleton-identity-copy { flex-basis: calc(100% - 63px); }.me-skeleton-identity-status { flex-basis: 100%; justify-items: start; padding-top: 17px; border-top: 1px solid var(--line); }.me-skeleton-section-heading { align-items: flex-start; }.me-skeleton-section-title { width: 128px; }.me-skeleton-action { width: 102px; height: 38px; }.me-skeleton-submission-row { align-items: flex-start; flex-direction: column; gap: 12px; padding: 16px; }.me-skeleton-submission-status { align-self: flex-start; } }
</style>
