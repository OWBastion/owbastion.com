...
const adminApi = vi.fn((path: string) => {
  if (path === "/v1/submissions?status=received,evidence_pending,evidence_stored,upload_pending,ocr_pending,ready_for_review,ocr_review_required,approved,rejected,resubmission_required&page=1&pageSize=20") return Promise.resolve({ items: [{ submissionId: "submission-1", mapName: "帕拉伊苏", difficulty: "困难", playerName: "他又", status: "ready_for_review" }, { submissionId: "submission-2", mapName: "釜山", difficulty: "专家", playerName: "他又", status: "ocr_review_required" }, { submissionId: "submission-3", mapName: "尼泊尔", difficulty: "地狱", playerName: "他又", status: "evidence_stored" }, { submissionId: "submission-4", mapName: "绿洲城", difficulty: "困难", playerName: "他又", status: "approved" }], total: 4 });
