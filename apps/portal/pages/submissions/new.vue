...
<style scoped>
.submit-page { padding-block: 72px; }.back-link { color: inherit; text-decoration: none; }.submit-intro { max-width: 650px; margin: 72px 0 32px; }.submit-layout { display: grid; grid-template-columns: minmax(0, 1fr) 310px; align-items: start; gap: 24px; }.catalog-pane { min-width: 0; padding: 22px; }.upload-panel { position: sticky; top: 24px; display: grid; gap: 20px; padding: 22px; }.upload-panel h2 { margin: 5px 0 0; color: var(--text); font-size: 1.3rem; letter-spacing: -.04em; }.catalog-loading { padding: 22px 0; color: var(--muted); }.selected-target { display: grid; gap: 6px; padding: 14px; border: 1px solid var(--line); border-radius: 12px; background: var(--accent-surface); }.selected-target span, .selected-target small { color: var(--muted); font-size: .78rem; }.selected-target strong { color: var(--text); }.selected-target.empty { background: var(--surface-raised); }.file-field { display: grid; gap: 8px; color: var(--muted); font-size: .82rem; }.file-field input { min-height: 46px; padding: 10px; border: 1px solid var(--line); border-radius: 10px; color: var(--text); background: var(--surface-raised); }.file-field small { color: var(--quiet); }.primary-button { min-height: 46px; padding: 0 16px; border: 0; border-radius: 10px; color: var(--on-accent); background: var(--accent); font-weight: 700; }.primary-button:disabled { opacity: .5; }.form-error { margin: 0; color: var(--danger); }.form-message { margin: 0; color: var(--muted); }
