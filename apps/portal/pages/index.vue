  ...
  <main class="site-shell">
    ...
    <section class="content-section" aria-labelledby="content-title">
      ...
      <div class="content-grid">
        ...
        <NuxtLink id="achievements" to="/achievements" class="content-card content-card--link pressable-soft"><p class="card-label">成就</p><h3>完成过的挑战</h3><p>查看已发布的目标与完成条件。</p></NuxtLink>
