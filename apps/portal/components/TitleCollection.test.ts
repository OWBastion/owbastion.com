...
const titles = [
  { grantId: "1", titleKey: "PIONEER", label: "开拓者", category: "社区贡献系列", scope: "map" as const, mapName: "暴雪世界", grantedAt: 30 },
  { grantId: "2", titleKey: "DOMINATOR", label: "主宰", category: "地图精通系列", scope: "map" as const, mapName: "暴雪世界", grantedAt: 20 },
  { grantId: "3", titleKey: "CONQUEROR", label: "征服者", category: "地图精通系列", scope: "map" as const, mapName: "哈瓦那", grantedAt: 10 },
  { grantId: "4", titleKey: "EVENT", label: "幸运星", category: "随机事件系列", scope: "global" as const, grantedAt: 40 },
  { grantId: "5", titleKey: "EVENT_2", label: "福星高照", category: "随机事件系列", scope: "global" as const, grantedAt: 5 },
  { grantId: "6", titleKey: "LONG", label: "这是一个超长的称号测试字段如果到这里还没有被截断", category: "开发保留", scope: "global" as const, grantedAt: 35 },
];
