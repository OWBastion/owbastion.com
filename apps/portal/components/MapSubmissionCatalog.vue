...
.map-selection { display: grid; gap: 10px; padding: 14px; border: 1px solid var(--line); border-radius: 12px; background: var(--surface); }.selection-heading { display: grid; gap: 3px; }.selection-heading span { color: var(--quiet); font-size: .74rem; }.selection-heading strong { color: var(--text); font-size: .95rem; }.map-objectives { display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 8px; }.objective-button { display: grid; gap: 4px; min-height: 64px; padding: 10px; border: 1px solid var(--line); border-radius: 9px; color: var(--muted); background: var(--surface-raised); font: inherit; text-align: left; }.objective-button strong { color: var(--text); font-size: .84rem; }.objective-button span { font-size: .74rem; }.objective-button:hover, .objective-button:focus-visible { border-color: var(--line-strong); }.objective-button.selected { border-color: var(--accent); background: var(--accent-surface); }.sunsetting { display: inline-flex; width: fit-content; align-items: center; gap: 5px; margin-top: 3px; border: 1px solid color-mix(in oklch, var(--warning) 38%, var(--line)); border-radius: 999px; overflow: hidden; color: color-mix(in oklch, var(--warning) 82%, var(--text)); background: color-mix(in oklch, var(--warning) 14%, var(--surface)); font-size: .68rem !important; font-weight: 700; }.sunsetting b { padding-left: 7px; }.sunsetting i { padding: 3px 7px 3px 5px; border-left: 1px solid color-mix(in oklch, var(--warning) 34%, var(--line)); color: var(--text); font-style: normal; font-weight: 650; }
