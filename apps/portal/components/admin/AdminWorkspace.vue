...
.admin-workspace__header h1 { margin: 0; font-size: var(--type-title-size); font-weight: 700; letter-spacing: var(--type-title-tracking); line-height: var(--type-title-leading); overflow-wrap: anywhere; }
.admin-workspace__count { color: var(--quiet); font-size: var(--type-caption-size); font-weight: 600; white-space: nowrap; }
...
.admin-toolbar { display: flex; align-items: center; gap: 0.5625rem; padding: 0.5625rem; border: 1px solid var(--line); border-radius: var(--radius-control); background: color-mix(in oklch, var(--surface) 92%, var(--surface-raised)); }
...
.admin-alert, .admin-feedback { margin: 0; padding: 0.75rem 0.875rem; border-radius: var(--radius-control); font-size: .82rem; }
