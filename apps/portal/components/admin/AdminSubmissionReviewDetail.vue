    ...
    <div class="detail-grid">
      ...
      <div class="info-col">
        <UCard class="actions-card">
          ...
          <div class="actions" :aria-busy="actionLoading || undefined">
            <UButton class="pressable" type="button" icon="i-lucide-check" label="通过" :loading="actionLoading" :disabled="actionsLoading" @click="emit('review', 'approved')" />
            <UButton class="pressable" type="button" icon="i-lucide-rotate-cw" label="要求重传" color="neutral" variant="outline" :loading="actionLoading" :disabled="actionsLoading" @click="emit('review', 'resubmission_required')" />
            <UButton class="pressable" type="button" icon="i-lucide-x" label="驳回" color="error" :loading="actionLoading" :disabled="actionsLoading" @click="emit('review', 'rejected')" />
          </div>
          <div class="ocr-retry-actions" :aria-busy="ocrRetryLoading || undefined">
            ...
            <UButton class="pressable" type="button" icon="i-lucide-refresh-cw" label="重新发送 OCRKit 请求" color="neutral" variant="outline" :loading="ocrRetryLoading" :disabled="actionsLoading" @click="emit('retry-ocr')" />
