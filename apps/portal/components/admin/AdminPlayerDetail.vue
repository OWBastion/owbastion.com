...
<template>
  <section class="player-detail" aria-label="玩家详情">
    ...
    <section id="overview" class="identity-card" aria-labelledby="player-identity-title">
      ...
      <section id="submissions" class="identity-card__activity" aria-labelledby="submissions-title">
...
@media (max-width: 760px) { .identity-card { grid-template-columns: 1fr; }.identity-card__actions { justify-content: flex-start; }.identity-card__activity { grid-column: auto; grid-row: auto; padding-left: 0; padding-top: 16px; border-left: 0; border-top: 1px solid var(--line); }.detail-grid { grid-template-columns: 1fr; }.detail-card--wide { grid-column: auto; } }
