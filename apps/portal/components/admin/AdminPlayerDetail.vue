...
.player-detail__top { display: grid; grid-template-columns: minmax(0, 1.2fr) minmax(300px, 1fr); align-items: start; gap: 16px; }
...
@media (max-width: 760px) { .player-detail__top { grid-template-columns: 1fr; }.identity-card { grid-template-columns: 1fr; }.identity-card__actions { justify-content: flex-start; }.detail-grid { grid-template-columns: 1fr; }.detail-card--wide { grid-column: auto; } }
