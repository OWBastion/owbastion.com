...
.player-binding-list, .submission-list { display: grid; gap: 9px; margin-top: 18px; }.player-binding-list__item, .submission-row { display: flex; align-items: center; justify-content: space-between; gap: 14px; min-width: 0; padding: 12px 0; border-bottom: 1px solid var(--line); }.player-binding-list__item:last-child, .submission-row:last-child { border-bottom: 0; }.player-binding-list__copy, .submission-row__map { min-width: 0; }.player-binding-list strong, .player-binding-list small, .submission-row strong, .submission-row small { display: block; overflow-wrap: anywhere; }.player-binding-list strong, .submission-row strong { font-size: .84rem; }.player-binding-list small, .submission-row small, .submission-row time { margin-top: 4px; color: var(--quiet); font-size: .72rem; }.submission-row time { flex: 0 0 auto; margin-top: 0; }.submission-row :deep(.status-badge) { flex: 0 0 auto; }
