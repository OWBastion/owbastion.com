...
<template>
  <section class="player-detail" aria-label="玩家详情">
    <nav class="detail-tabs" aria-label="玩家详情分区">
...
.detail-tabs { position: sticky; z-index: 3; top: 12px; display: flex; gap: 5px; width: fit-content; max-width: 100%; padding: 5px; overflow-x: auto; border: 1px solid color-mix(in oklch, var(--line) 76%, transparent); border-radius: 14px; background: color-mix(in oklch, var(--surface-raised) 84%, transparent); box-shadow: 0 10px 28px color-mix(in oklch, var(--text) 8%, transparent); backdrop-filter: blur(18px) saturate(150%); }
...
@media (prefers-reduced-transparency: reduce) { .detail-tabs { background: var(--surface-raised); backdrop-filter: none; } }
