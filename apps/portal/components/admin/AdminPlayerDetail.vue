...
<template>
  <section class="player-detail" aria-label="玩家详情">
    ...
    <div class="player-detail__split">
      ...
      <section id="submissions" class="detail-card detail-card--rail" aria-labelledby="submissions-title">
...
.player-detail__split { display: grid; grid-template-columns: minmax(0, 1.7fr) minmax(280px, 1fr); align-items: start; gap: 16px; }
...
@media (max-width: 760px) { .identity-card { grid-template-columns: 1fr; }.identity-card__actions { justify-content: flex-start; }.player-detail__split { grid-template-columns: 1fr; }.detail-card--rail { position: static; }.detail-grid { grid-template-columns: 1fr; }.detail-card--wide { grid-column: auto; } }
