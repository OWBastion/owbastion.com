...
const history = {
  ...
  runs: [
    ...
    { runId: "00000000-0000-4000-8000-000000000002", mapId: "map.samoa", gameplayRevisionId: "revision:map.samoa:initial", gameplayRevisionLifecycle: "default" as const, mapVariant: null, difficulty: "传奇" as const, completionDurationSeconds: 720, deaths: 2, skips: 1, awardedXp: 180, acceptedAt: 900, status: "invalidated" as const, matchCode: "1234-5678-9012" },
  ],
  page: 1,
  pageSize: 2,
  total: 3,
