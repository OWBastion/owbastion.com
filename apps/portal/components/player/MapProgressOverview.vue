...
.map-progress-card { container-type: inline-size; display: grid; gap: .85rem; min-width: 0; padding: 1.125rem; border: 1px solid var(--line); border-radius: var(--radius-card); background: var(--surface); }
