...
.title-group { overflow: clip; border: 1px solid var(--line); border-radius: 16px; background: color-mix(in oklch, var(--surface-raised) 76%, var(--surface)); }
.map-group { border-top: 1px solid var(--line); border-radius: 0; background: transparent; }
...
.title-group-content { padding: 0 20px 20px; }.map-groups { display: grid; gap: 4px; }.map-group-summary { min-height: 48px; padding: 10px 0; }.map-group .title-grid { padding: 4px 0 12px; }
...
@media (max-width: 620px) { .title-group-summary { min-height: 76px; padding: 16px; }.title-group-content { padding: 0 16px 16px; }.title-grid { grid-template-columns: 1fr; }.map-group .title-grid { padding: 4px 0 10px; } }
</style>
