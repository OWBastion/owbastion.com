...
| Historical title migration and grants | `coded` | Bastion owns historical facts; platform records historical and direct manual Grants | Generic Grant API, `/admin/titles`, `/admin/grants`, audit/idempotency code | Add production operational verification |
