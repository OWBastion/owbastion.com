...
INSERT INTO submissions_next (id, binding_id, status, challenge_type, map_name, source_provider, source_conversation_id, source_message_id, created_at, updated_at, challenge_id, difficulty, player_name, review_reason, grant_id, ocr_fail_count, target_map_id, rule_snapshot_json)
SELECT id, binding_id, status, challenge_type, map_name, source_provider, source_conversation_id, source_message_id, created_at, updated_at, challenge_id, difficulty, player_name, review_reason, grant_id, ocr_fail_count, target_map_id, rule_snapshot_json
FROM submissions;

INSERT INTO attachments_stage (id, submission_id, provider, external_attachment_id, content_type, byte_size, sha256, object_key, upload_status, created_at)
...
INSERT INTO ocr_results_stage (id, submission_id, attempt, status, response_json, match_json, error_code, created_at, request_id)
SELECT id, submission_id, attempt, status, response_json, match_json, error_code, created_at, request_id
FROM ocr_results;

INSERT INTO upload_sessions_stage (id, submission_id, player_account_id, content_type, byte_size, sha256, object_key, status, expires_at, created_at)
SELECT id, submission_id, player_account_id, content_type, byte_size, sha256, object_key, status, expires_at, created_at
FROM upload_sessions;

INSERT INTO submission_reviews_stage (id, submission_id, decision, reason, reviewer, created_at)
